            ...
            try:
                ...
                if order_data["order_type"] == "cash":
                    order_data.update({
                        ...
                        "cash_driver_name": safe_str(get_value(["Driver", "cash_driver_name", "Driver Name", "DriverName"])),
                        "cash_towing_vehicle": safe_str(get_value(["Towing Vehicle", "cash_towing_vehicle", "Towing", "Vehicle"])),
                        "cash_service_type": safe_str(get_value(["Service Type", "cash_service_type", "Service", "ServiceType"])),
                        "cash_vehicle_name": safe_str(get_value(["Vehicle Name", "cash_vehicle_name", "VehicleName"])),
                        "cash_vehicle_number": safe_str(get_value(["Vehicle Number", "cash_vehicle_number", "VehicleNumber", "Vehicle No"])),
                        "amount_received": safe_float(get_value(["Amount Received", "amount_received", "Amount", "Cash Amount", "Total Amount"])),
                        "advance_amount": safe_float(get_value(["Advance Amount", "advance_amount", "Advance", "AdvanceAmount"])),
                        "cash_kms_travelled": safe_float(get_value(["KMs Travelled", "cash_kms_travelled", "KMs", "Distance", "KM"])),
                    ...
                    order_data.update({
                        ...
                        "company_driver_name": safe_str(get_value(["Driver", "company_driver_name", "Driver Name", "DriverName"])),
                        "company_towing_vehicle": safe_str(get_value(["Towing Vehicle", "company_towing_vehicle", "Towing", "Vehicle"])),
                        "company_service_type": safe_str(get_value(["Service Type", "company_service_type", "Service", "ServiceType"])),
                        "company_vehicle_name": safe_str(get_value(["Vehicle Name", "company_vehicle_name", "VehicleName"])),
                        "company_vehicle_number": safe_str(get_value(["Vehicle Number", "company_vehicle_number", "VehicleNumber", "Vehicle No"])),
                        "company_kms_travelled": safe_float(get_value(["KMs Travelled", "company_kms_travelled", "KMs", "Distance", "KM"])),
                        "company_toll": safe_float(get_value(["Toll", "company_toll", "Toll Amount"])),
                        "company_diesel": safe_float(get_value(["Diesel", "company_diesel", "Diesel Amount"])),
